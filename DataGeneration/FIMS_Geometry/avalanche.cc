...
int main(int argc, char * argv[]) {
  ...
  fieldTransLimit = std::stod(readParam["fieldTransLimit"]);
  ...
  metaDataTree->Branch("Field Transparency Limit", &fieldTransLimit, "fieldTransLimit/D");
  ...
  std::string geometryPath = "input_file/";
